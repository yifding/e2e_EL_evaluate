...
INPUT_DIR=/scratch365/yding4/e2e_EL_evaluate/data/has_prob/prepare_split/rel
OUTPUT_DIR=/scratch365/yding4/e2e_EL_evaluate/data/has_prob/prepare_split/copy_rel_with_prob
DATASETS="['aida_testa','aida_testb','aida_train','ace2004','aquaint','clueweb','msnbc','wikipedia']"

python ${CODE} --input_dir ${INPUT_DIR} --output_dir ${OUTPUT_DIR} --datasets ${DATASETS}   --input_has_prob --output_has_prob
