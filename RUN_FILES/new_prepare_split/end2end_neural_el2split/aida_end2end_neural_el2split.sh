...
#$-l gpu_card=4
#$-N aida_end2end_neural_el2split
...
INPUT_DIR=/scratch365/yding4/e2e_EL_evaluate/data/aida/xml/xml_from_end2end_neural_el
OUTPUT_DIR=/scratch365/yding4/e2e_EL_evaluate/data/new_prepare_split/EL/end2end_neural_el/aida
