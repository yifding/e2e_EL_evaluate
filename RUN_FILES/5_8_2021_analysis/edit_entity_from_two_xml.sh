...
python ${CODE}  \
    --subset_xml_dir    /scratch365/yding4/e2e_EL_evaluate/data/5_8_2021_analysis/label_xml_EL \
    --full_xml_dir  /scratch365/yding4/e2e_EL_evaluate/data/5_8_2021_analysis/collect_pkl_rewrite_xml_EL   \
