...
python ${CODE}  \
    --subset_xml_dir    /scratch365/yding4/e2e_EL_evaluate/data/5_3_2021_investigation/label_xml_EL \
    --full_xml_dir  /scratch365/yding4/e2e_EL_evaluate/data/5_3_2021_investigation/collect_pkl_rewrite_xml_EL   \
