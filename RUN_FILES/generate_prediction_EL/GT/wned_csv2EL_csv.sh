...
INPUT_DIR=/scratch365/yding4/e2e_EL_evaluate/data/processed/wned/ori_xml2revise_xml
OUTPUT_DIR=/scratch365/yding4/e2e_EL_evaluate/data/prediction/EL/GT/wned
DATASETS="['ace2004','aquaint','wikipedia','clueweb','msnbc']"
