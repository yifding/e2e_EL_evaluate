...
def validation_loss_calculation(model, iterator, dataset_handle, opt_thr, el_mode, name=""):
    ...
    total_YD_tp, total_YD_fp, total_YD_fn, total_YD_overlap, total_GT = 0, 0, 0, 0, 0
    ...
    while True:
        try:
            ...
            """
            YD_tp, YD_fp, YD_fn, YD_overlap, GT = metrics_calculation_and_prediction_printing(evaluator, *result_l, scores_names_l, el_mode,
                                          printPredictions=printPredictions)
