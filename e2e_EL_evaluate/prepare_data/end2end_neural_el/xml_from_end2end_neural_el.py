...
def process_anno(ori_anno_list, txt, has_prob=False):
    """
    :param ori_anno_list: like: [(17, 7, 'Germany', 0.4130536913871765]), (49, 6, 'Angela_Merkel', 0.15916648507118225), (0, 5, 'Barack_Obama', 0.13012397289276123)]
    :param txt:
    ...
    for anno in ori_anno_list:
        ...
        if has_prob:
            ele['prob'] = anno[3]  # the ED probability is at index 3
