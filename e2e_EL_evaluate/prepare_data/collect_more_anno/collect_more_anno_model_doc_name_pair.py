    ...
    for model in args.models:
        ...
        for dataset in args.datasets:
            ...
            for doc_name in doc_name2txt:
                num_total += 1
                if doc_name in doc_name2anno and len(doc_name2anno[doc_name]) > args.K:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--output_file',
        type=str,
        default='EL_more_anno_model_doc_name_pair.pickle',
        help='',
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help='number of annotations allowed most',
    )
